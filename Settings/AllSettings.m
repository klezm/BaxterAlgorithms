...
sett.SegBgSubAlgorithm = Setting(...
    ...
    'default', 'none',...
    'alternatives_basic', {'none'; 'BgSub_median'; 'BgSub_min'; 'BgSub_image'},...
...
% use an image for background subtraction
sett.SegBgSubImage = Setting(...
    'name', 'SegBgSubImage',...
    'default', 'C:\code\cs_bsc_ba\microchannels\20190903_171036_DEL_dye\MyExperiment_WHITE_000023_subs_mean_.tif',...
    'type', 'file',...
    'category', 'segmentation',...
    'level', 'advanced',...
    'visiblefunction', @(x) NotLoad(x) &&...
    any(strcmpi({'BgSub_image'}, x.Get('SegBgSubAlgorithm'))),...
    'checkfunction', @IsNonNegative,...
    'tooltip', ['Image to use for background subtraction']);
